/* uppgiftermato1.js — Matematik – fortsättning nivå 1b och 1c.
   Reviderad runda 1: 400 uppgifter. Facit, nivåer, formatering, variation och figurer
   har kvalitetssäkrats mot ämnesplanen och nationella referensprov i Matematik 3c.
   SVG-figurer ligger inline och är mobilanpassade. */
...
window.BANKMATO1 = [
  ...
  },
  {
    ...
    "s": "<p><strong>Metod:</strong> Faktorisera täljare och nämnare innan du förkortar.</p><p>\\[\\frac{x^{2} - 9}{x - 3}=x + 3.\\]</p><p>Det ursprungliga uttrycket är inte definierat när nämnaren är noll.</p><p><strong>Svar:</strong> \\(\\boxed{x + 3}\\), med \\(x\\neq 3\\).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>Metod:</strong> Faktorisera täljare och nämnare innan du förkortar.</p><p>\\[\\frac{x^{2} - 4 x}{x}=x - 4.\\]</p><p>Det ursprungliga uttrycket är inte definierat när nämnaren är noll.</p><p><strong>Svar:</strong> \\(\\boxed{x - 4}\\), med \\(x\\neq 0\\).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>Metod:</strong> Faktorisera täljare och nämnare innan du förkortar.</p><p>\\[\\frac{x^{2} - 5 x + 6}{x - 2}=x - 3.\\]</p><p>Det ursprungliga uttrycket är inte definierat när nämnaren är noll.</p><p><strong>Svar:</strong> \\(\\boxed{x - 3}\\), med \\(x\\neq 2\\).</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "3/0/0",
    "t": "<p>Förenkla eller faktorisera.</p><p>a) \\((2x+3)(x-1)\\)<br>b) Faktorisera \\(x^{2} + 3 x - 4\\)<br>c) Faktorisera \\(2 x^{2} + x - 3\\).</p>",
    "s": "<p><strong>a)</strong> Multiplicera in parenteserna och samla liknande termer:</p><p>\\[2x^2+x-3\\]</p><p><strong>b)</strong> Sök två tal vars produkt är konstanttermen och vars summa är koefficienten framför \\(x\\):</p><p>\\[x^{2} + 3 x - 4=(x+4)(x-1).\\]</p><p><strong>c)</strong> Faktorisera genom att identifiera faktorer som ger rätt mittterm:</p><p>\\[(x-1)(2x+3)\\]</p><p><strong>Kontroll:</strong> Multiplicera tillbaka faktorerna i b) och c).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>Metod:</strong> Faktorisera täljare och nämnare innan du förkortar.</p><p>\\[\\frac{x^{2} - 1}{x + 1}=x - 1.\\]</p><p>Det ursprungliga uttrycket är inte definierat när nämnaren är noll.</p><p><strong>Svar:</strong> \\(\\boxed{x - 1}\\), med \\(x\\neq -1\\).</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "3/0/0",
    "t": "<p>Förenkla eller faktorisera.</p><p>a) \\((3x-2)(x+2)\\)<br>b) Faktorisera \\(x^{2} - 3 x - 10\\)<br>c) Faktorisera \\(3 x^{2} + 4 x - 4\\).</p>",
    "s": "<p><strong>a)</strong> Multiplicera in parenteserna och samla liknande termer:</p><p>\\[3x^2+4x-4\\]</p><p><strong>b)</strong> Sök två tal vars produkt är konstanttermen och vars summa är koefficienten framför \\(x\\):</p><p>\\[x^{2} - 3 x - 10=(x-5)(x+2).\\]</p><p><strong>c)</strong> Faktorisera genom att identifiera faktorer som ger rätt mittterm:</p><p>\\[(x+2)(3x-2)\\]</p><p><strong>Kontroll:</strong> Multiplicera tillbaka faktorerna i b) och c).</p>",
  ...
  },
  {
    ...
    "s": "<p>Vid division med ett bråk multiplicerar vi med dess invers:</p><p>\\[\\frac{x^2-4}{x+1}\\div\\frac{x-2}{x+1}=\\frac{(x-2)(x+2)}{x+1}\\cdot\\frac{x+1}{x-2}=x+2.\\]</p><p>I originaluttrycket måste \\(x\\neq-1\\). Dessutom får bråket vi dividerar med inte vara noll, så \\(x\\neq2\\).</p><p><strong>Svar:</strong> \\(\\boxed{x+2}\\), där \\(x\\neq-1,2\\).</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "3/0/0",
    "t": "<p>Förenkla eller faktorisera.</p><p>a) \\((2x-4)(x+3)\\)<br>b) Faktorisera \\(x^{2} + 4 x + 3\\)<br>c) Faktorisera \\(2 x^{2} + 2 x - 12\\).</p>",
    "s": "<p><strong>a)</strong> Multiplicera in parenteserna och samla liknande termer:</p><p>\\[2x^2+2x-12\\]</p><p><strong>b)</strong> Sök två tal vars produkt är konstanttermen och vars summa är koefficienten framför \\(x\\):</p><p>\\[x^{2} + 4 x + 3=(x+1)(x+3).\\]</p><p><strong>c)</strong> Faktorisera genom att identifiera faktorer som ger rätt mittterm:</p><p>\\[2(x-2)(x+3)\\]</p><p><strong>Kontroll:</strong> Multiplicera tillbaka faktorerna i b) och c).</p>",
  ...
  },
  {
    ...
    "s": "<p>Multiplicera täljare med täljare och nämnare med nämnare:</p><p>\\[\\frac{2x}{x-3}\\cdot\\frac{x+1}{4x}=\\frac{2x(x+1)}{4x(x-3)}.\\]</p><p>Förkorta med \\(2x\\):</p><p>\\[\\frac{x+1}{2(x-3)}=\\frac{x+1}{2x-6}.\\]</p><p>Originaluttrycket kräver \\(x\\neq3\\) och \\(x\\neq0\\).</p><p><strong>Svar:</strong> \\(\\boxed{\\frac{x+1}{2x-6}}\\), \\(x\\neq0,3\\).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>1. Otillåtna värden:</strong> \\(x\\neq-1\\) och \\(x\\neq1\\).</p><p><strong>2. Multiplicera med den gemensamma nämnaren \\((x+1)(x-1)\\):</strong></p><p>\\[(x-1)+(x+1)=(x+1)(x-1).\\]</p><p>\\[2x=x^2-1\\Rightarrow x^2-2x-1=0.\\]</p><p>Med pq-formeln fås</p><p>\\[x=1\\pm\\sqrt2.\\]</p><p>Båda värdena är tillåtna.</p><p><strong>Svar:</strong> \\(\\boxed{x=1-\\sqrt2\\text{ eller }x=1+\\sqrt2}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>1. Otillåtna värden:</strong> \\(x\\neq2\\) och \\(x\\neq-1\\).</p><p><strong>2. Multiplicera ekvationen med \\((x-2)(x+1)\\):</strong></p><p>\\[2(x+1)=3(x-2).\\]</p><p>\\[2x+2=3x-6\\Rightarrow x=8.\\]</p><p>Värdet är tillåtet i ursprungsekvationen.</p><p><strong>Svar:</strong> \\(\\boxed{x=8}\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>Funktionen definieras av</p><p>\\[f(x)=\\begin{cases}x-2,&x&lt;1\\\\x^2+c,&x\\ge 1.\\end{cases}\\]</p><p>Bestäm \\(c\\) så att funktionen är kontinuerlig vid \\(x=1\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "1/1/0",
    "t": "<p>Lös polynomekvationen</p><p>\\[x^{3} + 2 x^{2} - 9 x - 18=0.\\]</p>",
    "s": "<p><strong>Metod: gruppera termerna</strong> så att en gemensam faktor uppstår.</p><p>\\[x^{3} + 2 x^{2} - 9 x - 18=x^2(x+2)-9(x+2).\\]</p><p>Bryt ut den gemensamma faktorn:</p><p>\\[(x+2)(x^2-9)=0.\\]</p><p>Faktorisera sedan differensen av två kvadrater:</p><p>\\[\\left(x - 3\\right) \\left(x + 2\\right) \\left(x + 3\\right)=0.\\]</p><p>Enligt nollproduktmetoden måste någon faktor vara noll. Då fås</p><p>\\[x=-2,\\ x=3,\\ x=-3.\\]</p><p><strong>Svar:</strong> \\(\\boxed{x=-3,\\ -2,\\ 3}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>1. Otillåtet värde:</strong> \\(x\\neq1\\).</p><p><strong>2. Multiplicera med \\(x-1\\):</strong></p><p>\\[x+1=2(x-1).\\]</p><p>\\[x+1=2x-2\\Rightarrow x=3.\\]</p><p>Värdet är tillåtet.</p><p><strong>Svar:</strong> \\(\\boxed{x=3}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>a)</strong> \\(v=0\\) är inte tillåtet eftersom division med noll inte är definierad. I modellen skulle dessutom hastigheten 0 km/h innebära att resan aldrig blir färdig.</p><p><strong>b)</strong></p><p>\\[\\frac{240}{v}=4\\]</p><p>Multiplicera med \\(v\\) och dela med 4:</p><p>\\[240=4v\\Rightarrow v=60.\\]</p><p><strong>c)</strong> När \\(v\\) blir mycket stor blir \\(240/v\\) allt mindre och närmar sig 0.</p><p><strong>Svar:</strong> \\(\\boxed{v=60\\text{ km/h}}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>a)</strong> \\(v=0\\) är inte tillåtet eftersom division med noll inte är definierad. I sammanhanget skulle överföringshastigheten 0 MB/s dessutom innebära att överföringen aldrig blir klar.</p><p><strong>b)</strong></p><p>\\[\\frac{600}{v}=5\\]</p><p>Multiplicera med \\(v\\) och dela med 5:</p><p>\\[600=5v\\Rightarrow v=120.\\]</p><p><strong>c)</strong> När \\(v\\) ökar blir \\(600/v\\) allt mindre och närmar sig 0.</p><p><strong>Svar:</strong> \\(\\boxed{v=120\\text{ MB/s}}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p>Mittpunkten är \\(m=(1+2)/2=1,5\\).</p><p>\\[f(1)=-2,\\qquad f(1,5)=-0,125.\\]</p><p>Både \\(f(1)\\) och \\(f(1,5)\\) är negativa, så teckenbytet finns mellan \\(1,5\\) och \\(2\\).</p><p><strong>Svar:</strong> det nya intervallet är \\(\\boxed{[1,5;\\,2]}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p>a) \\(f(-1)=4\\).</p><p>b) \\(f(0)=1\\).</p><p>c) \\(f(2)=13\\).</p><p>d) Skriv funktionen som \\(f(x)=3x^2+1\\). Symmetrilinjen är därför \\(\\boxed{x=0}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p>Mittpunkten är \\(m=(1+2)/2=1,5\\).</p><p>\\[f(1)=-2,\\qquad f(1,5)=0,875.\\]</p><p>Nu har \\(f(1)\\) och \\(f(1,5)\\) olika tecken, så nollstället ligger mellan \\(1\\) och \\(1,5\\).</p><p><strong>Svar:</strong> det nya intervallet är \\(\\boxed{[1;\\,1,5]}\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "1/1/0",
    "t": "<p>Funktionen</p><p>\\[f(x)=\\frac{x^2-4}{x-2}\\]</p><p>är inte definierad vid \\(x=2\\). Bestäm vilket värde man ska sätta \\(f(2)\\) till för att den utvidgade funktionen ska bli kontinuerlig.</p>",
    "s": "<p>För \\(x\\neq2\\) gäller</p><p>\\[\\frac{x^2-4}{x-2}=\\frac{(x-2)(x+2)}{x-2}=x+2.\\]</p><p>Kontinuitet kräver att det nya funktionsvärdet är lika med gränsvärdet:</p><p>\\[f(2)=\\lim_{x\\to2}f(x)=2+2=4.\\]</p><p><strong>Svar:</strong> \\(\\boxed{f(2)=4}\\).</p>",
    "familj": "kontinuitet_fyll_hal"
  },
  {
    "id": "1.100",
    "kap": 1,
  ...
  },
  {
    ...
    "s": "<p>Derivatan är \\(f\\,\\!\\prime(x)=3 x^{2} - 2\\), så tangentens lutning är</p><p>\\[k=f\\,\\!\\prime(0)=-2.\\]</p><p>Punkten på grafen är \\((0,0)\\).</p><p>Med punkt-lutningsformen:</p><p>\\[y=-2x.\\]</p><p><strong>Svar:</strong> \\(\\boxed{y=- 2 x}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>Steg 1: Derivera funktionen.</strong></p><p>När man deriverar \\(e^{kx}\\) får man \\(ke^{kx}\\). Alltså</p><p>\\[f\\,\\!\\prime(x)=3\\cdot 0,5e^{0,5x}=1,5e^{0,5x}.\\]</p><p><strong>Steg 2: Bestäm punkt och lutning vid \\(x=0\\).</strong></p><p>\\[f(0)=3e^0=3\\]</p><p>och</p><p>\\[f\\,\\!\\prime(0)=1,5e^0=1,5.\\]</p><p>Tangenten går alltså genom \\((0,3)\\) och har lutningen \\(1,5\\).</p><p><strong>Steg 3: Skriv tangentens ekvation.</strong></p><p>\\[y-3=1,5x\\]</p><p>så</p><p>\\[y=1,5x+3.\\]</p><p><strong>Svar:</strong> \\(\\boxed{f\\,\\!\\prime(x)=1,5e^{0,5x}}\\) och tangenten är \\(\\boxed{y=1,5x+3}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p><strong>Steg 1: Ställ upp modellen.</strong></p><p>Låt \\(t\\) vara antalet timmar efter 08.00. Då är \\(N(t)=1800e^{kt}\\). Villkoret \\(N(6)=8100\\) ger</p><p>\\[e^{6k}=4,5\\Rightarrow k=\\frac{\\ln(4,5)}6.\\]</p><p><strong>Steg 2: Bestäm tillväxthastigheten.</strong></p><p>\\[N\\,\\!\\prime(t)=1800\\cdot\\frac{\\ln(4,5)}6e^{\\frac{\\ln(4,5)}6t}.\\]</p><p>Sätt \\(N\\,\\!\\prime(t)=900\\):</p><p>\\[1800\\cdot\\frac{\\ln(4,5)}6e^{\\frac{\\ln(4,5)}6t}=900.\\]</p><p>Efter division och logaritmering:</p><p>\\[t=\\frac{6\\ln\\!\\left(\\frac{3}{\\ln(4,5)}\\right)}{\\ln(4,5)}\\approx 2,754.\\]</p><p>Det är ungefär 2 h 45 min efter 08.00.</p><p><strong>Svar:</strong> cirka \\(\\boxed{10.45}\\).</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>Tabellen visar värden nära en punkt.</p><table class=\"tabell\"><tr><th>x</th><th>1,9</th><th>2</th><th>2,1</th></tr><tr><th>f(x)</th><td>2,51</td><td>3</td><td>3,51</td></tr></table><p>Approximera \\(f\\,\\!\\prime(2)\\) med en symmetrisk differenskvot.</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>Tabellen visar värden nära en punkt.</p><table class=\"tabell\"><tr><th>x</th><th>0,99</th><th>1</th><th>1,01</th></tr><tr><th>f(x)</th><td>4,0201</td><td>4</td><td>3,9801</td></tr></table><p>Approximera \\(f\\,\\!\\prime(1)\\) med en symmetrisk differenskvot.</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "3/0/0",
    "t": "<p>Figuren visar grafen till \\(f\\).</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Parabel med punkterna A, B och C\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><line x1=\"44.0\" y1=\"20\" x2=\"44.0\" y2=\"216\" stroke=\"#EEEDEF\"/><text x=\"44.0\" y=\"233\" text-anchor=\"middle\" font-size=\"10\" fill=\"#77727A\">-3</text><line x1=\"98.3\" y1=\"20\" x2=\"98.3\" y2=\"216\" stroke=\"#EEEDEF\"/><text x=\"98.3\" y=\"233\" text-anchor=\"middle\" font-size=\"10\" fill=\"#77727A\">-2</text><line x1=\"152.7\" y1=\"20\" x2=\"152.7\" y2=\"216\" stroke=\"#EEEDEF\"/><text x=\"152.7\" y=\"233\" text-anchor=\"middle\" font-size=\"10\" fill=\"#77727A\">-1</text><line x1=\"207.0\" y1=\"20\" x2=\"207.0\" y2=\"216\" stroke=\"#EEEDEF\"/><line x1=\"261.3\" y1=\"20\" x2=\"261.3\" y2=\"216\" stroke=\"#EEEDEF\"/><text x=\"261.3\" y=\"233\" text-anchor=\"middle\" font-size=\"10\" fill=\"#77727A\">1</text><line x1=\"315.7\" y1=\"20\" x2=\"315.7\" y2=\"216\" stroke=\"#EEEDEF\"/><text x=\"315.7\" y=\"233\" text-anchor=\"middle\" font-size=\"10\" fill=\"#77727A\">2</text><line x1=\"370.0\" y1=\"20\" x2=\"370.0\" y2=\"216\" stroke=\"#EEEDEF\"/><text x=\"370.0\" y=\"233\" text-anchor=\"middle\" font-size=\"10\" fill=\"#77727A\">3</text><line x1=\"44\" y1=\"216.0\" x2=\"370\" y2=\"216.0\" stroke=\"#EEEDEF\"/><text x=\"37\" y=\"219.0\" text-anchor=\"end\" font-size=\"10\" fill=\"#77727A\">-1</text><line x1=\"44\" y1=\"183.3\" x2=\"370\" y2=\"183.3\" stroke=\"#EEEDEF\"/><line x1=\"44\" y1=\"150.7\" x2=\"370\" y2=\"150.7\" stroke=\"#EEEDEF\"/><text x=\"37\" y=\"153.7\" text-anchor=\"end\" font-size=\"10\" fill=\"#77727A\">1</text><line x1=\"44\" y1=\"118.0\" x2=\"370\" y2=\"118.0\" stroke=\"#EEEDEF\"/><text x=\"37\" y=\"121.0\" text-anchor=\"end\" font-size=\"10\" fill=\"#77727A\">2</text><line x1=\"44\" y1=\"85.3\" x2=\"370\" y2=\"85.3\" stroke=\"#EEEDEF\"/><text x=\"37\" y=\"88.3\" text-anchor=\"end\" font-size=\"10\" fill=\"#77727A\">3</text><line x1=\"44\" y1=\"52.7\" x2=\"370\" y2=\"52.7\" stroke=\"#EEEDEF\"/><text x=\"37\" y=\"55.7\" text-anchor=\"end\" font-size=\"10\" fill=\"#77727A\">4</text><line x1=\"44\" y1=\"20.0\" x2=\"370\" y2=\"20.0\" stroke=\"#EEEDEF\"/><text x=\"37\" y=\"23.0\" text-anchor=\"end\" font-size=\"10\" fill=\"#77727A\">5</text><line x1=\"207.0\" y1=\"20\" x2=\"207.0\" y2=\"216\" stroke=\"#2B2527\" stroke-width=\"1.5\"/><line x1=\"44\" y1=\"183.3\" x2=\"370\" y2=\"183.3\" stroke=\"#2B2527\" stroke-width=\"1.5\"/><path d=\"M 75.2 244.8 L 76.6 240.8 L 78.0 236.9 L 79.3 233.1 L 80.7 229.3 L 82.0 225.5 L 83.4 221.7 L 84.8 218.0 L 86.1 214.4 L 87.5 210.8 L 88.8 207.2 L 90.2 203.7 L 91.5 200.2 L 92.9 196.7 L 94.3 193.3 L 95.6 189.9 L 97.0 186.6 L 98.3 183.3 L 99.7 180.1 L 101.1 176.9 L 102.4 173.7 L 103.8 170.6 L 105.1 167.5 L 106.5 164.5 L 107.8 161.5 L 109.2 158.5 L 110.6 155.6 L 111.9 152.7 L 113.3 149.9 L 114.6 147.1 L 116.0 144.3 L 117.4 141.6 L 118.7 138.9 L 120.1 136.3 L 121.4 133.7 L 122.8 131.1 L 124.1 128.6 L 125.5 126.2 L 126.9 123.7 L 128.2 121.3 L 129.6 119.0 L 130.9 116.7 L 132.3 114.4 L 133.6 112.2 L 135.0 110.0 L 136.4 107.9 L 137.7 105.8 L 139.1 103.7 L 140.4 101.7 L 141.8 99.7 L 143.2 97.8 L 144.5 95.9 L 145.9 94.0 L 147.2 92.2 L 148.6 90.4 L 149.9 88.7 L 151.3 87.0 L 152.7 85.3 L 154.0 83.7 L 155.4 82.1 L 156.7 80.6 L 158.1 79.1 L 159.5 77.7 L 160.8 76.3 L 162.2 74.9 L 163.5 73.6 L 164.9 72.3 L 166.2 71.0 L 167.6 69.8 L 169.0 68.7 L 170.3 67.6 L 171.7 66.5 L 173.0 65.4 L 174.4 64.4 L 175.8 63.5 L 177.1 62.5 L 178.5 61.7 L 179.8 60.8 L 181.2 60.0 L 182.5 59.3 L 183.9 58.6 L 185.3 57.9 L 186.6 57.3 L 188.0 56.7 L 189.3 56.1 L 190.7 55.6 L 192.1 55.1 L 193.4 54.7 L 194.8 54.3 L 196.1 54.0 L 197.5 53.7 L 198.9 53.4 L 200.2 53.2 L 201.6 53.0 L 202.9 52.9 L 204.3 52.7 L 205.6 52.7 L 207.0 52.7 L 208.4 52.7 L 209.7 52.7 L 211.1 52.9 L 212.4 53.0 L 213.8 53.2 L 215.2 53.4 L 216.5 53.7 L 217.9 54.0 L 219.2 54.3 L 220.6 54.7 L 221.9 55.1 L 223.3 55.6 L 224.7 56.1 L 226.0 56.7 L 227.4 57.3 L 228.7 57.9 L 230.1 58.6 L 231.5 59.3 L 232.8 60.0 L 234.2 60.8 L 235.5 61.7 L 236.9 62.5 L 238.2 63.5 L 239.6 64.4 L 241.0 65.4 L 242.3 66.5 L 243.7 67.6 L 245.0 68.7 L 246.4 69.8 L 247.8 71.0 L 249.1 72.3 L 250.5 73.6 L 251.8 74.9 L 253.2 76.3 L 254.5 77.7 L 255.9 79.1 L 257.3 80.6 L 258.6 82.1 L 260.0 83.7 L 261.3 85.3 L 262.7 87.0 L 264.0 88.7 L 265.4 90.4 L 266.8 92.2 L 268.1 94.0 L 269.5 95.9 L 270.8 97.8 L 272.2 99.7 L 273.6 101.7 L 274.9 103.7 L 276.3 105.8 L 277.6 107.9 L 279.0 110.0 L 280.4 112.2 L 281.7 114.4 L 283.1 116.7 L 284.4 119.0 L 285.8 121.3 L 287.1 123.7 L 288.5 126.2 L 289.9 128.6 L 291.2 131.1 L 292.6 133.7 L 293.9 136.3 L 295.3 138.9 L 296.6 141.6 L 298.0 144.3 L 299.4 147.1 L 300.7 149.9 L 302.1 152.7 L 303.4 155.6 L 304.8 158.5 L 306.2 161.5 L 307.5 164.5 L 308.9 167.5 L 310.2 170.6 L 311.6 173.7 L 313.0 176.9 L 314.3 180.1 L 315.7 183.3 L 317.0 186.6 L 318.4 189.9 L 319.7 193.3 L 321.1 196.7 L 322.5 200.2 L 323.8 203.7 L 325.2 207.2 L 326.5 210.8 L 327.9 214.4 L 329.2 218.0 L 330.6 221.7 L 332.0 225.5 L 333.3 229.3 L 334.7 233.1 L 336.0 236.9 L 337.4 240.8 L 338.8 244.8\" fill=\"none\" stroke=\"#B43123\" stroke-width=\"2.4\"/><circle cx=\"125.5\" cy=\"126.2\" r=\"4\" fill=\"#2A5D9E\"/><text x=\"132.5\" y=\"119.2\" font-size=\"11\" fill=\"#2A5D9E\">A</text><circle cx=\"207.0\" cy=\"52.7\" r=\"4\" fill=\"#2A5D9E\"/><text x=\"214.0\" y=\"45.7\" font-size=\"11\" fill=\"#2A5D9E\">B</text><circle cx=\"288.5\" cy=\"126.2\" r=\"4\" fill=\"#2A5D9E\"/><text x=\"295.5\" y=\"119.2\" font-size=\"11\" fill=\"#2A5D9E\">C</text></svg></span><p>Avgör om \\(f\\,\\!\\prime(x)\\) är positiv, negativ eller noll i punkterna A, B och C.</p>",
    "s": "<p><strong>A:</strong> grafen är stigande, alltså är derivatan <strong>positiv</strong>.</p><p><strong>B:</strong> tangenten är horisontell i maximipunkten, alltså är derivatan <strong>0</strong>.</p><p><strong>C:</strong> grafen är fallande, alltså är derivatan <strong>negativ</strong>.</p>",
  ...
  },
  {
    ...
    "niva": "A",
    "poang": "0/1/2",
    "t": "<p>En funktion har formen</p><p>\\[f(x)=a\\sqrt{x}+\\frac{b}{\\sqrt{x}},\\qquad x&gt;0.\\]</p><p>Det gäller att \\(f(4)=5\\) och \\(f\\,\\!\\prime(4)=\\frac{3}{8}\\).</p><p>Bestäm \\(a\\) och \\(b\\).</p>",
    "s": "<p>Skriv med potenser:</p><p>\\[f(x)=ax^{1/2}+bx^{-1/2}.\\]</p><p>Då</p><p>\\[f\\,\\!\\prime(x)=\\frac{a}{2}x^{-1/2}-\\frac{b}{2}x^{-3/2}.\\]</p><p>Villkoret \\(f(4)=5\\) ger</p><p>\\[2a+\\frac b2=5\\Rightarrow4a+b=10.\\]</p><p>Vid \\(x=4\\) är</p><p>\\[f\\,\\!\\prime(4)=\\frac a4-\\frac b{16}=\\frac38.\\]</p><p>Multiplicera med 16:</p><p>\\[4a-b=6.\\]</p><p>Lös systemet: \\(8a=16\\Rightarrow a=2\\), och därefter \\(b=2\\).</p><p><strong>Svar:</strong> \\(\\boxed{a=2,\\ b=2}\\).</p>",
    "familj": "derreg_avancerad_potens_parameter"
  },
  {
    "id": "2.59",
    "kap": 2,
  ...
  },
  {
    ...
    "s": "<p>\\[f\\,\\!\\prime(x)=2e^{0,5x}.\\]</p><p>Vid \\(x=0\\): \\(f(0)\\approx 4\\) och \\(f\\,\\!\\prime(0)\\approx 2\\).</p><p>Tangenten blir</p><p>\\[y-4=2x.\\]</p><p><strong>Svar:</strong> \\(y\\approx 2x+4\\).</p>",
  ...
  },
  {
    ...
    "s": "<p>Utgå från derivatans definition:</p><p>\\[f\\,\\!\\prime(1)=\\lim_{h\\to0}\\frac{f(1+h)-f(1)}h.\\]</p><p>Här är \\(f(1)=4\\) och</p><p>\\[f(1+h)=(1+h)^2+3=4+2h+h^2.\\]</p><p>Därför</p><p>\\[\\frac{f(1+h)-f(1)}h=\\frac{2h+h^2}{h}=2+h\\qquad(h\\neq0).\\]</p><p>Nu kan gränsvärdet tas:</p><p>\\[f\\,\\!\\prime(1)=\\lim_{h\\to0}(2+h)=2.\\]</p><p><strong>Svar:</strong> \\(\\boxed{2}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p>Utgå från derivatans definition:</p><p>\\[f\\,\\!\\prime(2)=\\lim_{h\\to0}\\frac{f(2+h)-f(2)}h.\\]</p><p>\\[f(2)=2\\cdot2^2-2=6.\\]</p><p>Vidare</p><p>\\[f(2+h)=2(2+h)^2-(2+h)=6+7h+2h^2.\\]</p><p>Alltså</p><p>\\[\\frac{f(2+h)-f(2)}h=\\frac{7h+2h^2}{h}=7+2h.\\]</p><p>När \\(h\\to0\\) fås</p><p>\\[f\\,\\!\\prime(2)=7.\\]</p><p><strong>Svar:</strong> \\(\\boxed{7}\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>Bestäm \\(a\\) och \\(b\\) så att</p><p>\\[f(x)=\\begin{cases}ax+b,&x&lt;1\\\\x^2-x+2,&x\\ge1\\end{cases}\\]</p><p>är både kontinuerlig och deriverbar vid \\(x=1\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>Bestäm \\(a\\) och \\(b\\) så att</p><p>\\[f(x)=\\begin{cases}ax+b,&x&lt;1\\\\x^2+3,&x\\ge1\\end{cases}\\]</p><p>är både kontinuerlig och deriverbar vid \\(x=1\\).</p>",
    "s": "<p><strong>Deriverbarhet:</strong> Vänsterdelens derivata är \\(a\\). Högerdelens derivata är \\(2x\\), som vid \\(x=1\\) är \\(2\\). Alltså \\(a=2\\).</p><p><strong>Kontinuitet:</strong> Högerdelens funktionsvärde vid 1 är \\(4\\). Vänsterdelens är \\(a+b=2+b\\). Därför \\(2+b=4\\), så \\(b=2\\).</p><p><strong>Svar:</strong> \\(\\boxed{a=2,\\ b=2}\\).</p>",
  ...
  },
  {
    ...
    "s": "<p>Skriv funktionen styckvis nära \\(x=3\\):</p><p>\\[f(x)=\\begin{cases}3-x,&x&lt;3\\\\x-3,&x\\ge3.\\end{cases}\\]</p><p>Vänsterderivatan är därför \\(-1\\), medan högerderivatan är \\(1\\).</p><p>Eftersom \\(-1\\neq1\\) är de ensidiga derivatorna olika.</p><p><strong>Slutsats:</strong> funktionen är inte deriverbar vid \\(x=3\\).</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>Visa genom derivering att \\(F(x)=\\frac{x^{3}}{3} + \\ln x\\) är en primitiv funktion till \\(f(x)=x^{2} + \\frac{1}{x}\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>Grafen till \\(f(x)=x-1\\) visas nedan.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"240\" viewBox=\"0 0 390 240\" role=\"img\" aria-label=\"Grafen y=x-1 med negativ och positiv area markerad\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"238\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><line x1=\"45.0\" y1=\"18\" x2=\"45.0\" y2=\"202\" stroke=\"#EEEDEF\"/><line x1=\"151.7\" y1=\"18\" x2=\"151.7\" y2=\"202\" stroke=\"#EEEDEF\"/><line x1=\"258.3\" y1=\"18\" x2=\"258.3\" y2=\"202\" stroke=\"#EEEDEF\"/><line x1=\"365.0\" y1=\"18\" x2=\"365.0\" y2=\"202\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"179.0\" x2=\"365\" y2=\"179.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"133.0\" x2=\"365\" y2=\"133.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"87.0\" x2=\"365\" y2=\"87.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"41.0\" x2=\"365\" y2=\"41.0\" stroke=\"#EEEDEF\"/><polygon points=\"45.0,133.0 45.0,179.0 151.7,133.0\" fill=\"#FBF0EE\" opacity=\"0.95\"/><polygon points=\"151.7,133.0 365.0,41.0 365.0,133.0\" fill=\"#EAF0F8\" opacity=\"0.95\"/><line x1=\"45\" y1=\"133.0\" x2=\"365\" y2=\"133.0\" stroke=\"#2B2527\"/><line x1=\"45\" y1=\"18\" x2=\"45\" y2=\"202\" stroke=\"#2B2527\"/><line x1=\"45.0\" y1=\"179.0\" x2=\"365.0\" y2=\"41.0\" stroke=\"#B43123\" stroke-width=\"2.5\"/><text x=\"82.3\" y=\"153.7\" font-size=\"11\" fill=\"#B43123\">negativ del</text><text x=\"226.3\" y=\"103.1\" font-size=\"11\" fill=\"#2A5D9E\">positiv del</text></svg></span><p>Beräkna både den bestämda integralen och den geometriska arean mellan grafen och x-axeln på intervallet \\([0,3]\\).</p>",
  ...
  },
  {
    ...
    "s": "<p>Nära \\(x=2\\) byter uttrycket \\(x^2-4\\) tecken. Därför kan funktionen skrivas</p><p>\\[f(x)=\\begin{cases}4-x^2,&x&lt;2\\\\x^2-4,&x\\ge2.\\end{cases}\\]</p><p>Vänsterderivatan vid 2 är \\(-2\\cdot2=-4\\). Högerderivatan är \\(2\\cdot2=4\\).</p><p>Eftersom \\(-4\\neq4\\) är funktionen <strong>inte deriverbar</strong> vid \\(x=2\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>Funktionen \\(f(x)=x|x|\\) har ett uttryck med absolutbelopp. Är den deriverbar vid \\(x=0\\)? Motivera.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"245\" viewBox=\"0 0 390 245\" role=\"img\" aria-label=\"Grafen till x gånger absolutbeloppet av x\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"243\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><line x1=\"66.1\" y1=\"20\" x2=\"66.1\" y2=\"207\" stroke=\"#EEEDEF\"/><line x1=\"136.3\" y1=\"20\" x2=\"136.3\" y2=\"207\" stroke=\"#EEEDEF\"/><line x1=\"206.5\" y1=\"20\" x2=\"206.5\" y2=\"207\" stroke=\"#EEEDEF\"/><line x1=\"276.7\" y1=\"20\" x2=\"276.7\" y2=\"207\" stroke=\"#EEEDEF\"/><line x1=\"346.9\" y1=\"20\" x2=\"346.9\" y2=\"207\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"190.9\" x2=\"368\" y2=\"190.9\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"158.6\" x2=\"368\" y2=\"158.6\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"126.4\" x2=\"368\" y2=\"126.4\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"94.2\" x2=\"368\" y2=\"94.2\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"61.9\" x2=\"368\" y2=\"61.9\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"29.7\" x2=\"368\" y2=\"29.7\" stroke=\"#EEEDEF\"/><line x1=\"206.5\" y1=\"20\" x2=\"206.5\" y2=\"207\" stroke=\"#2B2527\" stroke-width=\"1.4\"/><line x1=\"45\" y1=\"190.9\" x2=\"368\" y2=\"190.9\" stroke=\"#2B2527\" stroke-width=\"1.4\"/><path d=\"M 52.0 346.9 L 53.6 343.8 L 55.1 340.7 L 56.7 337.6 L 58.3 334.6 L 59.8 331.6 L 61.4 328.6 L 62.9 325.6 L 64.5 322.7 L 66.1 319.8 L 67.6 317.0 L 69.2 314.2 L 70.7 311.4 L 72.3 308.6 L 73.9 305.9 L 75.4 303.2 L 77.0 300.6 L 78.5 297.9 L 80.1 295.3 L 81.7 292.8 L 83.2 290.2 L 84.8 287.7 L 86.4 285.3 L 87.9 282.8 L 89.5 280.4 L 91.0 278.1 L 92.6 275.7 L 94.2 273.4 L 95.7 271.1 L 97.3 268.9 L 98.8 266.7 L 100.4 264.5 L 102.0 262.4 L 103.5 260.2 L 105.1 258.1 L 106.6 256.1 L 108.2 254.1 L 109.8 252.1 L 111.3 250.1 L 112.9 248.2 L 114.4 246.3 L 116.0 244.4 L 117.6 242.6 L 119.1 240.8 L 120.7 239.0 L 122.2 237.3 L 123.8 235.6 L 125.4 233.9 L 126.9 232.3 L 128.5 230.7 L 130.0 229.1 L 131.6 227.6 L 133.2 226.1 L 134.7 224.6 L 136.3 223.1 L 137.8 221.7 L 139.4 220.3 L 141.0 219.0 L 142.5 217.6 L 144.1 216.4 L 145.6 215.1 L 147.2 213.9 L 148.8 212.7 L 150.3 211.5 L 151.9 210.4 L 153.4 209.3 L 155.0 208.2 L 156.6 207.2 L 158.1 206.2 L 159.7 205.2 L 161.2 204.3 L 162.8 203.4 L 164.4 202.5 L 165.9 201.6 L 167.5 200.8 L 169.1 200.1 L 170.6 199.3 L 172.2 198.6 L 173.7 197.9 L 175.3 197.2 L 176.9 196.6 L 178.4 196.0 L 180.0 195.5 L 181.5 195.0 L 183.1 194.5 L 184.7 194.0 L 186.2 193.6 L 187.8 193.2 L 189.3 192.8 L 190.9 192.5 L 192.5 192.2 L 194.0 191.9 L 195.6 191.7 L 197.1 191.5 L 198.7 191.3 L 200.3 191.1 L 201.8 191.0 L 203.4 190.9 L 204.9 190.9 L 206.5 190.9\" fill=\"none\" stroke=\"#2A5D9E\" stroke-width=\"2.5\"/><path d=\"M 206.5 190.9 L 208.1 190.9 L 209.6 190.8 L 211.2 190.7 L 212.7 190.6 L 214.3 190.5 L 215.9 190.3 L 217.4 190.1 L 219.0 189.9 L 220.5 189.6 L 222.1 189.3 L 223.7 189.0 L 225.2 188.6 L 226.8 188.2 L 228.3 187.8 L 229.9 187.3 L 231.5 186.8 L 233.0 186.3 L 234.6 185.7 L 236.1 185.1 L 237.7 184.5 L 239.3 183.9 L 240.8 183.2 L 242.4 182.5 L 243.9 181.7 L 245.5 180.9 L 247.1 180.1 L 248.6 179.3 L 250.2 178.4 L 251.8 177.5 L 253.3 176.5 L 254.9 175.6 L 256.4 174.6 L 258.0 173.5 L 259.6 172.5 L 261.1 171.4 L 262.7 170.2 L 264.2 169.1 L 265.8 167.9 L 267.4 166.7 L 268.9 165.4 L 270.5 164.1 L 272.0 162.8 L 273.6 161.4 L 275.2 160.1 L 276.7 158.6 L 278.3 157.2 L 279.8 155.7 L 281.4 154.2 L 283.0 152.7 L 284.5 151.1 L 286.1 149.5 L 287.6 147.8 L 289.2 146.2 L 290.8 144.5 L 292.3 142.7 L 293.9 140.9 L 295.4 139.1 L 297.0 137.3 L 298.6 135.5 L 300.1 133.6 L 301.7 131.6 L 303.2 129.7 L 304.8 127.7 L 306.4 125.7 L 307.9 123.6 L 309.5 121.5 L 311.0 119.4 L 312.6 117.3 L 314.2 115.1 L 315.7 112.9 L 317.3 110.6 L 318.8 108.3 L 320.4 106.0 L 322.0 103.7 L 323.5 101.3 L 325.1 98.9 L 326.6 96.5 L 328.2 94.0 L 329.8 91.5 L 331.3 89.0 L 332.9 86.4 L 334.5 83.8 L 336.0 81.2 L 337.6 78.5 L 339.1 75.8 L 340.7 73.1 L 342.3 70.4 L 343.8 67.6 L 345.4 64.8 L 346.9 61.9 L 348.5 59.0 L 350.1 56.1 L 351.6 53.2 L 353.2 50.2 L 354.7 47.2 L 356.3 44.1 L 357.9 41.1 L 359.4 38.0 L 361.0 34.8\" fill=\"none\" stroke=\"#B43123\" stroke-width=\"2.5\"/><circle cx=\"206.5\" cy=\"190.9\" r=\"4\" fill=\"#2B2527\"/><text x=\"245\" y=\"40\" font-size=\"11\">y=x|x|</text></svg></span>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>Bestäm parametern \\(a\\) så att funktionen</p><p>\\[f(x)=\\begin{cases}x^2,&x\\le1\\\\ax+1-a,&x&gt;1\\end{cases}\\]</p><p>är deriverbar vid \\(x=1\\).</p>",
    "s": "<p>Först kontrolleras kontinuiteten. Vänsterdelen ger \\(f(1)=1\\), och högergränsvärdet är</p><p>\\[a\\cdot1+1-a=1,\\]</p><p>så funktionen är kontinuerlig vid \\(x=1\\) för alla \\(a\\).</p><p>Vänsterderivatan är derivatan av \\(x^2\\), alltså \\(2x\\), och vid \\(x=1\\) blir den \\(2\\).</p><p>Högerderivatan är \\(a\\). För deriverbarhet krävs</p><p>\\[a=2.\\]</p><p><strong>Svar:</strong> \\(\\boxed{a=2}\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>Från hörnen på ett 30 cm × 20 cm stort kartongark klipps fyra lika stora kvadrater med sidan \\(x\\) bort. Kanterna viks upp till en öppen låda.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Rektangulärt ark med fyra kvadrater bortklippta\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><rect x=\"58\" y=\"54\" width=\"274\" height=\"145\" fill=\"#F8FAFC\" stroke=\"#2B2527\" stroke-width=\"2\"/><rect x=\"58\" y=\"54\" width=\"38\" height=\"38\" fill=\"#FBF0EE\" stroke=\"#B43123\" stroke-width=\"1.5\"/><rect x=\"294\" y=\"54\" width=\"38\" height=\"38\" fill=\"#FBF0EE\" stroke=\"#B43123\" stroke-width=\"1.5\"/><rect x=\"58\" y=\"161\" width=\"38\" height=\"38\" fill=\"#FBF0EE\" stroke=\"#B43123\" stroke-width=\"1.5\"/><rect x=\"294\" y=\"161\" width=\"38\" height=\"38\" fill=\"#FBF0EE\" stroke=\"#B43123\" stroke-width=\"1.5\"/><text x=\"77\" y=\"79\" text-anchor=\"middle\" font-size=\"12\" fill=\"#B43123\">x</text><text x=\"195\" y=\"222\" text-anchor=\"middle\" font-size=\"12\">30 cm</text><text x=\"348\" y=\"129\" font-size=\"12\">20 cm</text><text x=\"195\" y=\"35\" text-anchor=\"middle\" font-size=\"12\" fill=\"#5C575E\">kvadrater med sidan x klipps bort</text></svg></span><p>Bestäm \\(x\\) så att lådans volym blir så stor som möjligt.</p>",
    "s": "<p>Efter vikningen blir höjden \\(x\\), längden \\(30-2x\\) och bredden \\(20-2x\\). Därför</p><p>\\[V(x)=x(30-2x)(20-2x),\\qquad 0&lt;x&lt;10.\\]</p><p>Utveckla före derivering:</p><p>\\[V(x)=4x^3-100x^2+600x.\\]</p><p>\\[V\\,\\!\\prime(x)=12x^2-200x+600.\\]</p><p>Ekvationen \\(V\\,\\!\\prime(x)=0\\) ger två rötter, men bara \\(x\\approx 3,92\\) ligger i intervallet \\(0&lt;x&lt;10\\) och ger maximum.</p><p>Volymen blir då ungefär \\(1056,3\\text{ cm}^3\\).</p><p><strong>Svar:</strong> \\(\\boxed{x\\approx 3,92\\text{ cm}}\\).</p>",
    "familj": "extrem_oppna_ladan"
  },
  {
    "id": "3.75",
    "kap": 3,
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>Funktionen \\(f\\) är kontinuerlig och består av två räta linjestycken som möts i punkten \\((2,3)\\). Vänster linjestycke har lutningen 4 och höger linjestycke lutningen \\(k\\).</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"235\" viewBox=\"0 0 390 235\" role=\"img\" aria-label=\"Två linjestycken som möts i punkten 2,3\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"233\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><line x1=\"45\" y1=\"190\" x2=\"365\" y2=\"190\" stroke=\"#2B2527\" stroke-width=\"1.4\"/><line x1=\"195\" y1=\"28\" x2=\"195\" y2=\"215\" stroke=\"#2B2527\" stroke-width=\"1.4\"/><line x1=\"68\" y1=\"178\" x2=\"246\" y2=\"72\" stroke=\"#2A5D9E\" stroke-width=\"2.5\"/><line x1=\"246\" y1=\"72\" x2=\"342\" y2=\"72\" stroke=\"#B43123\" stroke-width=\"2.5\"/><circle cx=\"246\" cy=\"72\" r=\"4\" fill=\"#2B2527\"/><text x=\"252\" y=\"62\" font-size=\"11\">(2,3)</text><text x=\"105\" y=\"116\" font-size=\"11\" fill=\"#2A5D9E\">lutning 4</text><text x=\"285\" y=\"61\" font-size=\"11\" fill=\"#B43123\">lutning k</text></svg></span><p>Vilket värde måste \\(k\\) ha för att \\(f\\) ska vara deriverbar vid \\(x=2\\)?</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>Bestäm \\(a\\) och \\(b\\) så att funktionen</p><p>\\[f(x)=\\begin{cases}ax+b,&x&lt;1\\\\x^2+1,&x\\ge1\\end{cases}\\]</p><p>är deriverbar vid \\(x=1\\).</p>",
  ...
  },
  {
    ...
    "s": "<p>a) Förflyttningen är den signerade integralen:</p><p>\\[\\int_0^5(2t-4)\\,dt=\\left[t^2-4t\\right]_0^5=5\\text{ m}.\\]</p><p>b) Hastigheten byter tecken vid \\(t=2\\). Sträckan blir därför</p><p>\\[s=-\\int_0^2(2t-4)\\,dt+\\int_2^5(2t-4)\\,dt=4+9=13\\text{ m}.\\]</p><p><strong>Svar:</strong> förflyttning \\(5\\) m, total sträcka \\(\\boxed{13\\text{ m}}\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>Ett läkemedel tillförs med en varierande hastighet \\(r(t)=0,6e^{0,2t}\\) mg/h under de första 5 timmarna.</p><p>Bestäm den totala mängd läkemedel som tillförs under perioden.</p>",
    "s": "<p>Mängden är integralen av tillförselhastigheten:</p><p>\\[M=\\int_0^5 0,6e^{0,2t}\\,dt.\\]</p><p>En primitiv funktion är \\(3e^{0,2t}\\). Därför</p><p>\\[M=\\left[3e^{0,2t}\\right]_0^5=3(e-1)\\approx5,15\\text{ mg}.\\]</p><p><strong>Svar:</strong> \\(\\boxed{5,15\\text{ mg}}\\).</p>",
    "familj": "intapp_exponentiellt_flode"
  },
  {
    "id": "3.115",
    "kap": 3,
  ...
  },
  {
    ...
    "s": "<p>Integralen kan tolkas som ett antal besökare bara om \\(r(t)\\) verkligen beskriver en <strong>ankomsthastighet</strong>, till exempel personer per timme, och om den kontinuerliga modellen är en rimlig approximation mellan mättillfällena.</p><p>Två möjliga felkällor är:</p><p>• ankomster sker diskret, medan modellen antar ett kontinuerligt flöde,<br>• värdena mellan heltimmarna är inte observerade och den valda interpolationen kan missa korta toppar eller dalar.</p><p>Även mätfel eller personer som registreras flera gånger kan påverka.</p><p><strong>Slutsats:</strong> integralen är en modellbaserad uppskattning, inte automatiskt ett exakt antal personer.</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>I triangeln är två sidor 7 cm och 9 cm och den mellanliggande vinkeln 48°.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Triangel med markerade sidor och vinklar\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"52,205 338,205 145,55\" fill=\"#F5F8FC\" stroke=\"#2B2527\" stroke-width=\"2\"/><text x=\"41\" y=\"222\" font-size=\"12\" fill=\"#2B2527\">A</text><text x=\"345\" y=\"222\" font-size=\"12\" fill=\"#2B2527\">B</text><text x=\"139\" y=\"43\" font-size=\"12\" fill=\"#2B2527\">C</text><text x=\"237\" y=\"130\" font-size=\"12\" fill=\"#2A5D9E\">7</text><text x=\"92\" y=\"129\" font-size=\"12\" fill=\"#2A5D9E\">9</text><text x=\"153\" y=\"81\" font-size=\"12\" fill=\"#0F6B4F\">48°</text><text x=\"190\" y=\"223\" font-size=\"12\" fill=\"#2A5D9E\">?</text></svg></span><p>Bestäm den tredje sidan.</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>I triangeln är två sidor 5,5 cm och 8,2 cm och den mellanliggande vinkeln 63°.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Triangel med markerade sidor och vinklar\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"52,205 338,205 145,55\" fill=\"#F5F8FC\" stroke=\"#2B2527\" stroke-width=\"2\"/><text x=\"41\" y=\"222\" font-size=\"12\" fill=\"#2B2527\">A</text><text x=\"345\" y=\"222\" font-size=\"12\" fill=\"#2B2527\">B</text><text x=\"139\" y=\"43\" font-size=\"12\" fill=\"#2B2527\">C</text><text x=\"237\" y=\"130\" font-size=\"12\" fill=\"#2A5D9E\">5,5</text><text x=\"92\" y=\"129\" font-size=\"12\" fill=\"#2A5D9E\">8,2</text><text x=\"153\" y=\"81\" font-size=\"12\" fill=\"#0F6B4F\">63°</text><text x=\"190\" y=\"223\" font-size=\"12\" fill=\"#2A5D9E\">?</text></svg></span><p>Bestäm den tredje sidan.</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>I triangeln är två sidor 12 cm och 15 cm och den mellanliggande vinkeln 35°.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Triangel med markerade sidor och vinklar\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"52,205 338,205 145,55\" fill=\"#F5F8FC\" stroke=\"#2B2527\" stroke-width=\"2\"/><text x=\"41\" y=\"222\" font-size=\"12\" fill=\"#2B2527\">A</text><text x=\"345\" y=\"222\" font-size=\"12\" fill=\"#2B2527\">B</text><text x=\"139\" y=\"43\" font-size=\"12\" fill=\"#2B2527\">C</text><text x=\"237\" y=\"130\" font-size=\"12\" fill=\"#2A5D9E\">12</text><text x=\"92\" y=\"129\" font-size=\"12\" fill=\"#2A5D9E\">15</text><text x=\"153\" y=\"81\" font-size=\"12\" fill=\"#0F6B4F\">35°</text><text x=\"190\" y=\"223\" font-size=\"12\" fill=\"#2A5D9E\">?</text></svg></span><p>Bestäm den tredje sidan.</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>Två sidor i en triangel är 8 cm och 11 cm. Vinkeln mellan dem är 42°.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"400\" height=\"315\" viewBox=\"0 0 470 315\" role=\"img\" aria-label=\"Triangel\"><rect x=\"1\" y=\"1\" width=\"400\" height=\"313\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"70,250 400,250 250,70\" fill=\"#F4F8FC\" stroke=\"#2B2527\" stroke-width=\"2.2\"/><circle cx=\"70\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"52\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">A</text><circle cx=\"400\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"410\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">B</text><circle cx=\"250\" cy=\"70\" r=\"3.8\" fill=\"#B43123\"/><text x=\"245\" y=\"58\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">C</text><text x=\"339.0\" y=\"160.0\" text-anchor=\"middle\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2A5D9E\">8</text><text x=\"140.0\" y=\"160.0\" text-anchor=\"middle\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2A5D9E\">11</text><text x=\"260\" y=\"98\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2E7D52\">42°</text></svg></span><p>Bestäm triangelns area.</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>Två sidor i en triangel är 6,5 cm och 9,2 cm. Vinkeln mellan dem är 75°.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"400\" height=\"315\" viewBox=\"0 0 470 315\" role=\"img\" aria-label=\"Triangel\"><rect x=\"1\" y=\"1\" width=\"400\" height=\"313\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"70,250 400,250 250,70\" fill=\"#F4F8FC\" stroke=\"#2B2527\" stroke-width=\"2.2\"/><circle cx=\"70\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"52\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">A</text><circle cx=\"400\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"410\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">B</text><circle cx=\"250\" cy=\"70\" r=\"3.8\" fill=\"#B43123\"/><text x=\"245\" y=\"58\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">C</text><text x=\"339.0\" y=\"160.0\" text-anchor=\"middle\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2A5D9E\">6,5</text><text x=\"140.0\" y=\"160.0\" text-anchor=\"middle\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2A5D9E\">9,2</text><text x=\"260\" y=\"98\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2E7D52\">75°</text></svg></span><p>Bestäm triangelns area.</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>Ett företag planerar två produkter \\(x\\) och \\(y\\). Begränsningarna är</p><p>\\[2x+1y\\le 40,\\qquad x+3y\\le 45,\\qquad x,y\\ge0.\\]</p><p>Intäkten är \\(I=120x+150y\\). Bestäm den optimala lösningen.</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>Två sidor i en triangel är 13 cm och 7 cm. Vinkeln mellan dem är 28°.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"400\" height=\"315\" viewBox=\"0 0 470 315\" role=\"img\" aria-label=\"Triangel\"><rect x=\"1\" y=\"1\" width=\"400\" height=\"313\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"70,250 400,250 250,70\" fill=\"#F4F8FC\" stroke=\"#2B2527\" stroke-width=\"2.2\"/><circle cx=\"70\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"52\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">A</text><circle cx=\"400\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"410\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">B</text><circle cx=\"250\" cy=\"70\" r=\"3.8\" fill=\"#B43123\"/><text x=\"245\" y=\"58\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">C</text><text x=\"339.0\" y=\"160.0\" text-anchor=\"middle\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2A5D9E\">13</text><text x=\"140.0\" y=\"160.0\" text-anchor=\"middle\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2A5D9E\">7</text><text x=\"260\" y=\"98\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2E7D52\">28°</text></svg></span><p>Bestäm triangelns area.</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>Härled areasatsen \\(A=\\frac12ab\\sin C\\) från formeln \\(A=\\frac12\\cdot bas\\cdot höjd\\).</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Triangel med bas a, sida b, vinkeln C och höjden h\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"65,205 335,205 165,55\" fill=\"#F5F8FC\" stroke=\"#2B2527\" stroke-width=\"2\"/>\n    <line x1=\"165\" y1=\"55\" x2=\"165\" y2=\"205\" stroke=\"#B43123\" stroke-width=\"1.6\" stroke-dasharray=\"5 4\"/>\n    <path d=\"M165 190 L180 190 L180 205\" fill=\"none\" stroke=\"#B43123\" stroke-width=\"1.4\"/>\n    <text x=\"199\" y=\"225\" font-size=\"12\" fill=\"#2A5D9E\">a</text>\n    <text x=\"101\" y=\"124\" font-size=\"12\" fill=\"#2A5D9E\">b</text>\n    <text x=\"82\" y=\"190\" font-size=\"12\" fill=\"#0F6B4F\">C</text>\n    <text x=\"173\" y=\"127\" font-size=\"12\" fill=\"#B43123\">h = b sin C</text></svg></span>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>I en triangel gäller \\(a=7\\) cm, \\(A=40^\\circ\\) och \\(B=65^\\circ\\). Bestäm sidan \\(b\\).</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Triangel där sidan a och vinklarna A och B är givna\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"54,205 336,205 154,57\" fill=\"#F5F8FC\" stroke=\"#2B2527\" stroke-width=\"2\"/><text x=\"42\" y=\"222\" font-size=\"12\">A</text><text x=\"343\" y=\"222\" font-size=\"12\">B</text><text x=\"149\" y=\"45\" font-size=\"12\">C</text><text x=\"75\" y=\"191\" font-size=\"12\" fill=\"#0F6B4F\">40°</text><text x=\"306\" y=\"191\" font-size=\"12\" fill=\"#0F6B4F\">65°</text><text x=\"246\" y=\"126\" font-size=\"12\" fill=\"#2A5D9E\">a = 7 cm</text><text x=\"92\" y=\"126\" font-size=\"12\" fill=\"#2A5D9E\">b = ?</text></svg></span>",
  ...
  },
  {
    ...
    "niva": "A",
    "poang": "0/0/3",
    "t": "<p>Bevisa sinussatsen</p><p>\\[\\frac a{\\sin A}=\\frac b{\\sin B}=\\frac c{\\sin C}\\]</p><p>genom att uttrycka triangelns area på flera sätt.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Godtycklig triangel med standardbeteckningarna A, B, C och a, b, c\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"55,205 337,205 155,57\" fill=\"#F5F8FC\" stroke=\"#2B2527\" stroke-width=\"2\"/>\n    <text x=\"43\" y=\"222\" font-size=\"12\">A</text><text x=\"344\" y=\"222\" font-size=\"12\">B</text><text x=\"150\" y=\"45\" font-size=\"12\">C</text>\n    <text x=\"247\" y=\"127\" font-size=\"12\" fill=\"#2A5D9E\">a</text><text x=\"92\" y=\"127\" font-size=\"12\" fill=\"#2A5D9E\">b</text><text x=\"193\" y=\"225\" font-size=\"12\" fill=\"#2A5D9E\">c</text>\n    <text x=\"73\" y=\"191\" font-size=\"11\" fill=\"#0F6B4F\">A</text><text x=\"309\" y=\"191\" font-size=\"11\" fill=\"#0F6B4F\">B</text><text x=\"160\" y=\"77\" font-size=\"11\" fill=\"#0F6B4F\">C</text></svg></span>",
  ...
  },
  {
    ...
    "s": "<p>Använd enhetscirkeln och sök de vinklar där cosinusvärdet är \\(- \\frac{1}{2}\\).</p><p><strong>Svar:</strong> \\(120^\\circ, 240^\\circ\\).</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>I en triangel gäller \\(a=9\\) cm, \\(A=52^\\circ\\) och \\(B=73^\\circ\\). Bestäm sidan \\(b\\).</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Triangel där sidan a och vinklarna A och B är givna\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"54,205 336,205 154,57\" fill=\"#F5F8FC\" stroke=\"#2B2527\" stroke-width=\"2\"/><text x=\"42\" y=\"222\" font-size=\"12\">A</text><text x=\"343\" y=\"222\" font-size=\"12\">B</text><text x=\"149\" y=\"45\" font-size=\"12\">C</text><text x=\"75\" y=\"191\" font-size=\"12\" fill=\"#0F6B4F\">52°</text><text x=\"306\" y=\"191\" font-size=\"12\" fill=\"#0F6B4F\">73°</text><text x=\"246\" y=\"126\" font-size=\"12\" fill=\"#2A5D9E\">a = 9 cm</text><text x=\"92\" y=\"126\" font-size=\"12\" fill=\"#2A5D9E\">b = ?</text></svg></span>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "1/0/0",
    "t": "<p>I en triangel gäller \\(a=12\\) cm, \\(A=35^\\circ\\) och \\(B=81^\\circ\\). Bestäm sidan \\(b\\).</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Triangel där sidan a och vinklarna A och B är givna\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"54,205 336,205 154,57\" fill=\"#F5F8FC\" stroke=\"#2B2527\" stroke-width=\"2\"/><text x=\"42\" y=\"222\" font-size=\"12\">A</text><text x=\"343\" y=\"222\" font-size=\"12\">B</text><text x=\"149\" y=\"45\" font-size=\"12\">C</text><text x=\"75\" y=\"191\" font-size=\"12\" fill=\"#0F6B4F\">35°</text><text x=\"306\" y=\"191\" font-size=\"12\" fill=\"#0F6B4F\">81°</text><text x=\"246\" y=\"126\" font-size=\"12\" fill=\"#2A5D9E\">a = 12 cm</text><text x=\"92\" y=\"126\" font-size=\"12\" fill=\"#2A5D9E\">b = ?</text></svg></span>",
  ...
  },
  {
    ...
    "s": "<p>Använd enhetscirkeln och sök de vinklar där cosinusvärdet är \\(0\\).</p><p><strong>Svar:</strong> \\(90^\\circ, 270^\\circ\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>I en triangel är \\(A=35^\\circ\\), \\(a=10\\) cm och \\(b=14\\) cm.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Två möjliga trianglar med samma givna vinkel och sidlängder\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><line x1=\"35\" y1=\"205\" x2=\"355\" y2=\"205\" stroke=\"#2B2527\" stroke-width=\"1.5\"/><line x1=\"50\" y1=\"205\" x2=\"187.6\" y2=\"108.6\" stroke=\"#2A5D9E\" stroke-width=\"2.4\"/><line x1=\"187.6\" y1=\"108.6\" x2=\"116.1\" y2=\"205\" stroke=\"#B43123\" stroke-width=\"2.2\"/><line x1=\"187.6\" y1=\"108.6\" x2=\"259.1\" y2=\"205\" stroke=\"#0F6B4F\" stroke-width=\"2.2\"/><circle cx=\"50\" cy=\"205\" r=\"3\" fill=\"#2B2527\"/><circle cx=\"187.6\" cy=\"108.6\" r=\"3\" fill=\"#2B2527\"/><circle cx=\"116.1\" cy=\"205\" r=\"3\" fill=\"#B43123\"/><circle cx=\"259.1\" cy=\"205\" r=\"3\" fill=\"#0F6B4F\"/><text x=\"42\" y=\"224\" font-size=\"12\">A</text><text x=\"108.1\" y=\"224\" font-size=\"11\" fill=\"#B43123\">B₁</text><text x=\"251.1\" y=\"224\" font-size=\"11\" fill=\"#0F6B4F\">B₂</text><text x=\"182.6\" y=\"99.6\" font-size=\"12\">C</text><text x=\"68\" y=\"192\" font-size=\"12\" fill=\"#0F6B4F\">A = 35°</text><text x=\"103.8\" y=\"147.8\" font-size=\"12\" fill=\"#2A5D9E\">b = 14</text><text x=\"147.9\" y=\"148.8\" font-size=\"11\" fill=\"#B43123\">a</text><text x=\"227.4\" y=\"148.8\" font-size=\"11\" fill=\"#0F6B4F\">a</text></svg></span><p>Undersök hur många olika trianglar som är möjliga och bestäm de möjliga värdena på vinkeln \\(B\\).</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "2/0/0",
    "t": "<p>I en rätvinklig triangel är hypotenusan 10 cm och en spetsig vinkel 35°.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"400\" height=\"315\" viewBox=\"0 0 470 315\" role=\"img\" aria-label=\"Rätvinklig triangel\"><rect x=\"1\" y=\"1\" width=\"400\" height=\"313\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"70,250 400,250 250,70\" fill=\"#F4F8FC\" stroke=\"#2B2527\" stroke-width=\"2.2\"/><circle cx=\"70\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"52\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">A</text><circle cx=\"400\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"410\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">B</text><circle cx=\"250\" cy=\"70\" r=\"3.8\" fill=\"#B43123\"/><text x=\"245\" y=\"58\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">C</text><text x=\"339.0\" y=\"160.0\" text-anchor=\"middle\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2A5D9E\">10 cm</text><text x=\"95\" y=\"238\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2E7D52\">35°</text><text x=\"260\" y=\"98\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2E7D52\">90°</text></svg></span><p>Bestäm längden av de båda kateterna.</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>I en triangel är \\(A=42^\\circ\\), \\(a=12\\) cm och \\(b=16\\) cm.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Två möjliga trianglar med samma givna vinkel och sidlängder\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><line x1=\"35\" y1=\"205\" x2=\"355\" y2=\"205\" stroke=\"#2B2527\" stroke-width=\"1.5\"/><line x1=\"50\" y1=\"205\" x2=\"180.8\" y2=\"87.2\" stroke=\"#2A5D9E\" stroke-width=\"2.4\"/><line x1=\"180.8\" y1=\"87.2\" x2=\"121.2\" y2=\"205\" stroke=\"#B43123\" stroke-width=\"2.2\"/><line x1=\"180.8\" y1=\"87.2\" x2=\"240.4\" y2=\"205\" stroke=\"#0F6B4F\" stroke-width=\"2.2\"/><circle cx=\"50\" cy=\"205\" r=\"3\" fill=\"#2B2527\"/><circle cx=\"180.8\" cy=\"87.2\" r=\"3\" fill=\"#2B2527\"/><circle cx=\"121.2\" cy=\"205\" r=\"3\" fill=\"#B43123\"/><circle cx=\"240.4\" cy=\"205\" r=\"3\" fill=\"#0F6B4F\"/><text x=\"42\" y=\"224\" font-size=\"12\">A</text><text x=\"113.2\" y=\"224\" font-size=\"11\" fill=\"#B43123\">B₁</text><text x=\"232.4\" y=\"224\" font-size=\"11\" fill=\"#0F6B4F\">B₂</text><text x=\"175.8\" y=\"78.2\" font-size=\"12\">C</text><text x=\"68\" y=\"192\" font-size=\"12\" fill=\"#0F6B4F\">A = 42°</text><text x=\"100.4\" y=\"137.1\" font-size=\"12\" fill=\"#2A5D9E\">b = 16</text><text x=\"147.0\" y=\"138.1\" font-size=\"11\" fill=\"#B43123\">a</text><text x=\"214.6\" y=\"138.1\" font-size=\"11\" fill=\"#0F6B4F\">a</text></svg></span><p>Undersök hur många olika trianglar som är möjliga och bestäm de möjliga värdena på vinkeln \\(B\\).</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "2/0/0",
    "t": "<p>I en rätvinklig triangel är hypotenusan 14 cm och en spetsig vinkel 52°.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"400\" height=\"315\" viewBox=\"0 0 470 315\" role=\"img\" aria-label=\"Rätvinklig triangel\"><rect x=\"1\" y=\"1\" width=\"400\" height=\"313\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"70,250 400,250 250,70\" fill=\"#F4F8FC\" stroke=\"#2B2527\" stroke-width=\"2.2\"/><circle cx=\"70\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"52\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">A</text><circle cx=\"400\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"410\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">B</text><circle cx=\"250\" cy=\"70\" r=\"3.8\" fill=\"#B43123\"/><text x=\"245\" y=\"58\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">C</text><text x=\"339.0\" y=\"160.0\" text-anchor=\"middle\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2A5D9E\">14 cm</text><text x=\"95\" y=\"238\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2E7D52\">52°</text><text x=\"260\" y=\"98\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2E7D52\">90°</text></svg></span><p>Bestäm längden av de båda kateterna.</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>Två fyrar A och B ligger 4,8 km från varandra. Från en båt mäts vinklarna mot A och B så att triangeln båt-A-B har vinklarna 38° vid A och 67° vid B.</p><p>Bestäm båtens avstånd till fyr A.</p>",
    "s": "<p>Den tredje vinkeln är \\(180^\\circ-38^\\circ-67^\\circ=75^\\circ\\). Sidan AB=4,8 km ligger mot 75°. Avståndet från båten till A ligger mot 67°.</p><p>Sinussatsen ger</p><p>\\[\\frac{AP}{\\sin67^\\circ}=\\frac{4,8}{\\sin75^\\circ}.\\]</p><p>\\[AP\\approx4,57\\text{ km}.\\]</p><p><strong>Svar:</strong> \\(\\boxed{4,57\\text{ km}}\\).</p>",
    "familj": "trig_unik_4_58"
  },
  {
    "id": "4.59",
    "kap": 4,
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "2/0/0",
    "t": "<p>I en rätvinklig triangel är hypotenusan 8 cm och en spetsig vinkel 27°.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"400\" height=\"315\" viewBox=\"0 0 470 315\" role=\"img\" aria-label=\"Rätvinklig triangel\"><rect x=\"1\" y=\"1\" width=\"400\" height=\"313\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"70,250 400,250 250,70\" fill=\"#F4F8FC\" stroke=\"#2B2527\" stroke-width=\"2.2\"/><circle cx=\"70\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"52\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">A</text><circle cx=\"400\" cy=\"250\" r=\"3.8\" fill=\"#B43123\"/><text x=\"410\" y=\"268\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">B</text><circle cx=\"250\" cy=\"70\" r=\"3.8\" fill=\"#B43123\"/><text x=\"245\" y=\"58\" font-family=\"IBM Plex Mono,monospace\" font-size=\"12\" font-weight=\"600\" fill=\"#2B2527\">C</text><text x=\"339.0\" y=\"160.0\" text-anchor=\"middle\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2A5D9E\">8 cm</text><text x=\"95\" y=\"238\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2E7D52\">27°</text><text x=\"260\" y=\"98\" font-family=\"IBM Plex Mono,monospace\" font-size=\"11.5\" fill=\"#2E7D52\">90°</text></svg></span><p>Bestäm längden av de båda kateterna.</p>",
  ...
  },
  {
    ...
    "niva": "A",
    "poang": "0/0/3",
    "t": "<p>Bevisa cosinussatsen \\(c^2=a^2+b^2-2ab\\cos C\\) genom att dela en godtycklig triangel med en höjd från ett hörn.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"250\" viewBox=\"0 0 390 250\" role=\"img\" aria-label=\"Triangel med höjd från B till sidan b för bevis av cosinussatsen\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"248\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><polygon points=\"60,205 337,205 155,57\" fill=\"#F5F8FC\" stroke=\"#2B2527\" stroke-width=\"2\"/>\n    <line x1=\"155\" y1=\"57\" x2=\"155\" y2=\"205\" stroke=\"#B43123\" stroke-width=\"1.6\" stroke-dasharray=\"5 4\"/>\n    <path d=\"M155 190 L170 190 L170 205\" fill=\"none\" stroke=\"#B43123\" stroke-width=\"1.4\"/>\n    <text x=\"48\" y=\"222\" font-size=\"12\">C</text><text x=\"344\" y=\"222\" font-size=\"12\">A</text><text x=\"150\" y=\"45\" font-size=\"12\">B</text>\n    <text x=\"100\" y=\"126\" font-size=\"12\" fill=\"#2A5D9E\">a</text><text x=\"246\" y=\"128\" font-size=\"12\" fill=\"#2A5D9E\">c</text><text x=\"195\" y=\"225\" font-size=\"12\" fill=\"#2A5D9E\">b</text>\n    <text x=\"79\" y=\"190\" font-size=\"12\" fill=\"#0F6B4F\">C</text><text x=\"163\" y=\"126\" font-size=\"12\" fill=\"#B43123\">a sin C</text>\n    <text x=\"91\" y=\"220\" font-size=\"10\" fill=\"#5C575E\">a cos C</text><text x=\"213\" y=\"220\" font-size=\"10\" fill=\"#5C575E\">b - a cos C</text></svg></span>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>En fotbollsspelare passar bollen 28 m till en lagkamrat. Därifrån går nästa passning 34 m. I lagkamratens position är vinkeln mellan riktningen tillbaka mot den första spelaren och den andra passningen \\(72^\\circ\\).</p><p>Hur långt från den första spelaren befinner sig bollen efter den andra passningen?</p>",
    "s": "<p>De två passningarna och förbindelsen tillbaka bildar en triangel. Cosinussatsen ger</p><p>\\[d^2=28^2+34^2-2\\cdot28\\cdot34\\cos72^\\circ.\\]</p><p>\\[d\\approx36,8\\text{ m}.\\]</p><p><strong>Svar:</strong> cirka \\(\\boxed{36,8\\text{ m}}\\).</p>",
    "familj": "trig_unik_4_63"
  },
  {
    "id": "4.64",
    "kap": 4,
    ...
    "niva": "E",
    "poang": "3/0/0",
    "t": "<p>Figuren visar det tillåtna området för ett linjärt optimeringsproblem.</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"260\" viewBox=\"0 0 390 260\" role=\"img\" aria-label=\"Tillåtet område i ett linjärt optimeringsproblem\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"258\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><line x1=\"45.0\" y1=\"20\" x2=\"45.0\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"109.0\" y1=\"20\" x2=\"109.0\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"173.0\" y1=\"20\" x2=\"173.0\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"237.0\" y1=\"20\" x2=\"237.0\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"301.0\" y1=\"20\" x2=\"301.0\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"365.0\" y1=\"20\" x2=\"365.0\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"220.0\" x2=\"365\" y2=\"220.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"180.0\" x2=\"365\" y2=\"180.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"140.0\" x2=\"365\" y2=\"140.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"100.0\" x2=\"365\" y2=\"100.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"60.0\" x2=\"365\" y2=\"60.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"20.0\" x2=\"365\" y2=\"20.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"220\" x2=\"365\" y2=\"220\" stroke=\"#2B2527\" stroke-width=\"1.5\"/><line x1=\"45\" y1=\"220\" x2=\"45\" y2=\"20\" stroke=\"#2B2527\" stroke-width=\"1.5\"/><polygon points=\"45.0,220.0 237.0,220.0 173.0,140.0 45.0,60.0\" fill=\"#EAF0F8\" stroke=\"#2A5D9E\" stroke-width=\"2\" opacity=\"0.9\"/><text x=\"365\" y=\"240\" font-size=\"11\">x</text><text x=\"51\" y=\"30\" font-size=\"11\">y</text></svg></span><p>Målfunktionen är \\(Z=3x+5y\\). Bestäm största värdet på \\(Z\\).</p>",
    "s": "<p>Det räcker att pröva hörnpunkterna i det tillåtna området: \\((0,0),(0,8),(4,4),(6,0)\\).</p><p>\\[Z=0,40,32,18.\\]</p><p><strong>Svar:</strong> största värdet är \\(\\boxed{40}\\) i punkten \\((0,8)\\).</p>",
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "2/0/0",
    "t": "<p>En takstol bildar en likbent triangel. Varje sned taksida är 5,2 m och vinkeln mellan taksidorna vid nocken är 74°.</p><p>Bestäm takstolens bredd.</p>",
    "s": "<p>Halvera den likbenta triangeln. Då fås en rätvinklig triangel med toppvinkel \\(37^\\circ\\) och hypotenusa 5,2 m. Halva bredden är</p><p>\\[5,2\\sin37^\\circ\\approx3,13\\text{ m}.\\]</p><p>Hela bredden blir \\(6,26\\) m.</p><p><strong>Svar:</strong> \\(\\boxed{6,26\\text{ m}}\\).</p>",
    "familj": "trig_unik_4_68"
  },
  {
    "id": "4.69",
    "kap": 4,
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>Ett djurfoder blandas av råvarorna X och Y. Minst 20 enheter protein och minst 18 enheter mineral krävs. Ett kg X ger 4 protein och 2 mineral och kostar 12 kr. Ett kg Y ger 2 protein och 3 mineral och kostar 10 kr.</p><p>Bestäm den billigaste blandningen.</p>",
    "s": "<p>Låt \\(x,y\\ge0\\) vara kilogram X och Y. Kraven blir</p><p>\\[4x+2y\\ge20,\\qquad2x+3y\\ge18.\\]</p><p>Kostnaden är \\(K=12x+10y\\). Minimum fås i en hörnpunkt nära origo. Skärningen mellan begränsningslinjerna ges av</p><p>\\[2x+y=10,\\quad2x+3y=18.\\]</p><p>Subtraktion ger \\(2y=8\\Rightarrow y=4\\), och då \\(x=3\\).</p><p>Kostnaden blir \\(12\\cdot3+10\\cdot4=76\\) kr, vilket är lägre än axelhörnen.</p><p><strong>Svar:</strong> \\(\\boxed{x=3,\\ y=4}\\), kostnad 76 kr.</p>",
    "familj": "linopt_minimering_foder"
  },
  {
    "id": "4.70",
    "kap": 4,
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "2/0/0",
    "t": "<p>En boll släpps från 2,0 m höjd. Efter varje studs når den 70 % av föregående maxhöjd.</p><p>Hur stor är summan av de fem första maxhöjderna efter studsar?</p>",
    "s": "<p>Höjderna bildar en geometrisk följd med första term \\(a_1=2,0\\cdot0,70=1,4\\) och kvot \\(k=0,70\\).</p><p>\\[S_5=1,4\\frac{1-0,7^5}{1-0,7}\\approx3,88\\text{ m}.\\]</p><p><strong>Svar:</strong> \\(\\boxed{3,88\\text{ m}}\\).</p>",
    "familj": "geosum_unik_4_75"
  },
  {
    "id": "4.76",
    "kap": 4,
  ...
  },
  {
    ...
    "niva": "E",
    "poang": "2/0/0",
    "t": "<p>En vandringsled går först 6,0 km norrut och sedan 8,0 km i riktningen 35° öster om norr.</p><p>Hur långt är det från startpunkten till slutpunkten?</p>",
    "s": "<p>Den inre vinkeln mellan den första sträckan bakåt och den andra sträckan är \\(180^\\circ-35^\\circ=145^\\circ\\). Cosinussatsen:</p><p>\\[d^2=6^2+8^2-2\\cdot6\\cdot8\\cos145^\\circ.\\]</p><p>\\[d\\approx13,36\\text{ km}.\\]</p><p><strong>Svar:</strong> \\(\\boxed{13,36\\text{ km}}\\).</p>",
    "familj": "trig_unik_4_78"
  },
  {
    "id": "4.79",
    "kap": 4,
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>En kontinuerlig linjär modell för antal stora och små transportfordon ger optimum \\((x,y)=(5,4;8,7)\\).</p><p>Förklara varför detta inte automatiskt är en genomförbar lösning och beskriv en systematisk metod för att hitta bästa heltalslösning.</p>",
    "s": "<p>Antal fordon måste vara heltal, så det kontinuerliga optimumet är inte genomförbart.</p><p>En systematisk metod är att identifiera heltalspunkter nära optimumet, till exempel \\((5,8),(5,9),(6,8),(6,9)\\), kontrollera vilka som uppfyller samtliga begränsningar och därefter jämföra målfunktionen för alla genomförbara kandidater. Om begränsningarna gör någon av dessa omöjlig behöver fler närliggande heltalspunkter prövas.</p>",
    "familj": "linopt_heltal"
  },
  {
    "id": "4.80",
    "kap": 4,
    ...
    "s": "<p>Antalet i varje figur bildar en geometrisk följd med \\(a_1=6\\), \\(k=3\\) och \\(n=7\\).</p><p>\\[S_7=6\\frac{1-3^7}{1-3}=6558.\\]</p><p><strong>Svar:</strong> \\(\\boxed{6558}\\) trianglar.</p>",
  ...
  },
  {
    ...
    "s": "<p>Bestäm först vinkeln \\(C\\) mellan sidorna 42 m och 55 m med cosinussatsen:</p><p>\\[\\cos C=\\frac{42^2+55^2-63^2}{2\\cdot42\\cdot55}.\\]</p><p>Det ger \\(C\\approx79,8^\\circ\\). Areasatsen ger sedan</p><p>\\[A=\\frac12\\cdot42\\cdot55\\sin79,8^\\circ\\approx1137\\text{ m}^2.\\]</p><p><strong>Svar:</strong> cirka \\(\\boxed{1140\\text{ m}^2}\\).</p>",
  ...
  },
  {
    ...
    "niva": "A",
    "poang": "0/1/2",
    "t": "<p>Det tillåtna området har hörnpunkterna \\((0,0),(0,6),(4,4),(8,0)\\). Bestäm alla värden på \\(p\\) för vilka målfunktionen \\(Z=px+6y\\) har fler än en optimal lösning.</p>",
    "s": "<p>Fler än en optimal lösning uppstår när en nivålinje till målfunktionen är parallell med en kant som ligger på maximisidan.</p><p>Kanten mellan \\((0,6)\\) och \\((4,4)\\) har lutning \\((4-6)/(4-0)=-1/2\\). Nivålinjen \\(px+6y=c\\) har lutning \\(-p/6\\). Parallellitet ger \\(-p/6=-1/2\\Rightarrow p=3\\).</p><p>Kanten mellan \\((4,4)\\) och \\((8,0)\\) har lutning \\(-1\\), vilket ger \\(p=6\\). Då är dock värdet på kanten \\(Z=48\\), större än i \\((0,6)\\), så även detta ger en hel optimal kant.</p><p><strong>Svar:</strong> \\(\\boxed{p=3\\text{ eller }p=6}\\).</p>",
    "familj": "linopt_parameter_flera_optima"
  },
  {
    "id": "4.85",
    "kap": 4,
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>En kampanjfilm delas först av 40 personer. Varje omgång delar i genomsnitt 1,6 gånger så många nya personer filmen som i föregående omgång.</p><p>En elev använder en geometrisk summa för att uppskatta det totala antalet delningar efter 8 omgångar. Beräkna uppskattningen och nämn en begränsning i modellen.</p>",
    "s": "<p>Modellen ger \\(a_1=40\\), \\(k=1,6\\), \\(n=8\\):</p><p>\\[S_8=40\\frac{1-1,6^8}{1-1,6}\\approx2796,6.\\]</p><p>En begränsning är att samma tillväxtfaktor knappast kan fortsätta oförändrad: målgruppen är ändlig och personer kan överlappa mellan omgångarna.</p><p><strong>Svar:</strong> cirka \\(\\boxed{2800}\\) delningar enligt modellen.</p>",
    "familj": "geosum_unik_4_85"
  },
  {
    "id": "4.86",
    "kap": 4,
  ...
  },
  {
    ...
    "niva": "A",
    "poang": "0/1/2",
    "t": "<p>Ett företag optimerar produktionen av två varor med en linjär modell. Modellen antar att varje extra vara alltid kräver samma mängd arbetstid och råvara och ger samma vinst.</p><p>Ge två realistiska situationer där dessa antaganden kan göra modellens optimum missvisande, och förklara hur modellen skulle kunna förbättras.</p>",
    "s": "<p>Två exempel:</p><p>1. <strong>Övertid eller mängdrabatter:</strong> kostnad/vinst per enhet kan ändras efter en viss produktionsnivå. Då är målfunktionen inte linjär över hela området. En styckvis linjär modell kan vara bättre.</p><p>2. <strong>Startkostnader eller kapacitetssteg:</strong> en maskin kan behöva startas om produktionen passerar en gräns. Då uppstår diskreta beslut och en kontinuerlig LP-modell kan ge ett ogenomförbart optimum.</p><p>Andra relevanta förbättringar är heltalsvillkor eller fler begränsningar som beskriver den verkliga processen.</p>",
    "familj": "linopt_modellkritik"
  },
  {
    "id": "4.90",
    "kap": 4,
    ...
    "s": "<p>Skriv \\(S_4=a(1-k^4)/(1-k)=30\\). De fyra nästa termerna är de fyra första multiplicerade med \\(k^4\\), så</p><p>\\[S_8=S_4+k^4S_4=30(1+k^4)=510.\\]</p><p>\\[1+k^4=17\\Rightarrow k^4=16.\\]</p><p>För en reell geometrisk följd kan \\(k=2\\) eller \\(k=-2\\). Sätt in i \\(S_4\\):</p><p>För \\(k=2\\): \\(30=a(1+2+4+8)=15a\\Rightarrow a=2\\).</p><p>För \\(k=-2\\): \\(30=a(1-2+4-8)=-5a\\Rightarrow a=-6\\).</p><p><strong>Svar:</strong> \\(\\boxed{(a,k)=(2,2)\\text{ eller }(-6,-2)}\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>En vinkel \\(v\\) ligger i andra kvadranten och \\(\\sin v=0,8\\).</p><p>Bestäm exakt \\(\\cos(180^\\circ-v)\\) utan att först bestämma vinkeln \\(v\\).</p>",
    "s": "<p>På enhetscirkeln gäller \\(\\sin^2v+\\cos^2v=1\\). Därför</p><p>\\[\\cos^2v=1-0,8^2=0,36.\\]</p><p>I andra kvadranten är cosinus negativ, alltså \\(\\cos v=-0,6=-3/5\\).</p><p>Vinkeln \\(180^\\circ-v\\) ligger speglad i första kvadranten och får motsatt x-koordinat. Därför</p><p>\\[\\cos(180^\\circ-v)=\\frac35.\\]</p><p><strong>Svar:</strong> \\(\\boxed{3/5}\\).</p>",
    "familj": "unitcirkel_transformation_resonemang"
  },
  {
    "id": "4.92",
    "kap": 4,
  ...
  },
  {
    ...
    "niva": "A",
    "poang": "0/1/2",
    "t": "<p>Två mätstationer A och B ligger 120 m från varandra. Ett föremål P observeras så att \\(\\angle A=32^\\circ\\) och \\(\\angle B=118^\\circ\\).</p><p>En elev påstår att avståndet AP måste vara kortare än BP eftersom vinkeln vid A är mindre. Undersök påståendet och bestäm båda avstånden.</p>",
    "s": "<p>Den tredje vinkeln är \\(30^\\circ\\). Sidan AB=120 m ligger mot 30°.</p><p>Sinussatsen ger</p><p>\\[\\frac{AP}{\\sin118^\\circ}=\\frac{120}{\\sin30^\\circ},\\qquad \\frac{BP}{\\sin32^\\circ}=\\frac{120}{\\sin30^\\circ}.\\]</p><p>Alltså \\(AP\\approx211,9\\) m och \\(BP\\approx127,2\\) m.</p><p>Påståendet är fel: större vinkel ligger mot längre sida, så AP är längre än BP.</p>",
    "familj": "trig_unik_4_93"
  },
  {
    "id": "4.94",
    "kap": 4,
    ...
    "niva": "C",
    "poang": "0/2/0",
    "t": "<p>I ett linjärt optimeringsproblem är det optimala hörnet \\((6,4)\\). Målfunktionen är \\(Z=5x+py\\).</p><p>Förklara varför en liten förändring av parametern \\(p\\) ibland kan flytta optimum till ett annat hörn, även om det tillåtna området inte ändras.</p>",
    "s": "<p>Nivålinjerna till målfunktionen har lutningen \\(-5/p\\). När \\(p\\) ändras roterar alltså nivålinjerna medan det tillåtna området ligger kvar.</p><p>Så länge samma hörn är längst i förbättringsriktningen ligger optimum kvar i \\((6,4)\\). Om lutningen passerar lutningen hos en angränsande kant kan en annan hörnpunkt börja ge större värde. Vid gränsfallet kan en hel kant vara optimal.</p>",
    "familj": "linopt_kanslighet"
  },
  {
    "id": "4.95",
    "kap": 4,
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>En maskin tappar 8 % av sin produktionskapacitet för varje år den används. Första året producerar den 12 000 enheter.</p><p>Hur många enheter producerar den sammanlagt under de första 10 åren enligt modellen?</p>",
    "s": "<p>Årsproduktionen bildar en geometrisk följd med \\(a_1=12000\\) och \\(k=0,92\\).</p><p>\\[S_{10}=12000\\frac{1-0,92^{10}}{1-0,92}\\approx84841,7.\\]</p><p><strong>Svar:</strong> cirka \\(\\boxed{84\\,800}\\) enheter.</p>",
    "familj": "geosum_unik_4_95"
  },
  {
    "id": "4.96",
    "kap": 4,
    ...
    "niva": "A",
    "poang": "0/1/2",
    "t": "<p>En punkt \\(P=(x,y)\\) ligger på enhetscirkeln i andra kvadranten. Dessutom gäller att</p><p>\\[x+y=\\frac15.\\]</p><p>Bestäm koordinaterna för \\(P\\) exakt och ange därmed \\(\\cos v\\) och \\(\\sin v\\), där \\(v\\) är punktens vinkel från positiva x-axeln.</p>",
    "s": "<p>Eftersom \\(P\\) ligger på enhetscirkeln gäller</p><p>\\[x^2+y^2=1.\\]</p><p>Från \\(x+y=1/5\\) fås \\(y=1/5-x\\). Sätt in i cirkelekvationen:</p><p>\\[x^2+\\left(\\frac15-x\\right)^2=1.\\]</p><p>Multiplicera med 25 och förenkla:</p><p>\\[50x^2-10x-24=0\\Rightarrow25x^2-5x-12=0.\\]</p><p>Faktorisera:</p><p>\\[(5x+3)(5x-4)=0.\\]</p><p>Alltså \\(x=-3/5\\) eller \\(x=4/5\\). Punkten ligger i andra kvadranten, så \\(x&lt;0\\) och \\(y&gt;0\\). Därför måste</p><p>\\[x=-\\frac35,\\qquad y=\\frac15+\\frac35=\\frac45.\\]</p><p>På enhetscirkeln är x-koordinaten cosinus och y-koordinaten sinus.</p><p><strong>Svar:</strong> \\(\\boxed{P=(-3/5;\\,4/5)}\\), \\(\\boxed{\\cos v=-3/5}\\), \\(\\boxed{\\sin v=4/5}\\).</p>",
  ...
  },
  {
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>En triangel har två sidor 10 cm och 14 cm. Bestäm vilket intervall triangelns area kan ligga i när vinkeln mellan sidorna får variera mellan 25° och 140°.</p><p>Motivera var minsta respektive största möjliga area uppstår.</p>",
    "s": "<p>Areasatsen ger \\(A(C)=\\frac12\\cdot10\\cdot14\\sin C=70\\sin C\\).</p><p>På intervallet \\(25^\\circ\\le C\\le140^\\circ\\) blir sinus störst vid \\(90^\\circ\\), så största area är \\(70\\) cm².</p><p>För minimum jämförs ändpunkterna: \\(70\\sin25^\\circ\\approx29,6\\) och \\(70\\sin140^\\circ\\approx45,0\\). Minsta arean fås därför vid 25°.</p><p><strong>Svar:</strong> \\(\\boxed{29,6\\lesssim A\\le70\\text{ cm}^2}\\).</p>",
    "familj": "trig_unik_4_98"
  },
  {
    "id": "4.99",
    "kap": 4,
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>Det tillåtna området bestäms av \\(2x+y\\le10\\), \\(x+2y\\le8\\) och \\(x,y\\ge0\\).</p><span class=\"fig\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"390\" height=\"260\" viewBox=\"0 0 390 260\" role=\"img\" aria-label=\"Tillåtet område i ett linjärt optimeringsproblem\"><rect x=\"1\" y=\"1\" width=\"388\" height=\"258\" rx=\"8\" fill=\"#fff\" stroke=\"#E4E3E6\"/><line x1=\"45.0\" y1=\"20\" x2=\"45.0\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"136.4\" y1=\"20\" x2=\"136.4\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"227.9\" y1=\"20\" x2=\"227.9\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"319.3\" y1=\"20\" x2=\"319.3\" y2=\"220\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"220.0\" x2=\"365\" y2=\"220.0\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"162.9\" x2=\"365\" y2=\"162.9\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"105.7\" x2=\"365\" y2=\"105.7\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"48.6\" x2=\"365\" y2=\"48.6\" stroke=\"#EEEDEF\"/><line x1=\"45\" y1=\"220\" x2=\"365\" y2=\"220\" stroke=\"#2B2527\" stroke-width=\"1.5\"/><line x1=\"45\" y1=\"220\" x2=\"45\" y2=\"20\" stroke=\"#2B2527\" stroke-width=\"1.5\"/><polygon points=\"45.0,220.0 273.6,220.0 227.9,162.9 45.0,105.7\" fill=\"#EAF0F8\" stroke=\"#2A5D9E\" stroke-width=\"2\" opacity=\"0.9\"/><text x=\"365\" y=\"240\" font-size=\"11\">x</text><text x=\"51\" y=\"30\" font-size=\"11\">y</text></svg></span><p>För vilket hörn blir \\(Z=4x+3y\\) störst? Visa både grafiskt resonemang och kontroll i hörnpunkterna.</p>",
    "s": "<p>Hörnpunkterna är \\((0,0),(0,4),(4,2),(5,0)\\).</p><p>\\[Z=0,12,22,20.\\]</p><p>Största värdet är 22 i \\((4,2)\\). Grafiskt kan en nivålinje \\(4x+3y=c\\) flyttas parallellt i riktning mot större \\(c\\); den sista kontakten med området sker i samma hörn.</p><p><strong>Svar:</strong> \\(\\boxed{(4,2)}\\), med \\(Z_{\\max}=22\\).</p>",
    "familj": "linopt_graf_och_horn"
  },
  {
    "id": "4.100",
    "kap": 4,
    ...
    "niva": "C",
    "poang": "1/2/0",
    "t": "<p>Två sparmodeller jämförs. Modell A ger utbetalningarna 1000, 1100, 1210, ... kr. Modell B ger 1000 kr första året och därefter 150 kr mer varje år.</p><p>Bestäm vilken modell som ger störst sammanlagd utbetalning under de första 8 åren och förklara varför modellerna växer olika.</p>",
    "s": "<p>Modell A är geometrisk med \\(a_1=1000\\) och \\(k=1,10\\):</p><p>\\[S_A=1000\\frac{1-1,1^8}{1-1,1}\\approx11436\\text{ kr}.\\]</p><p>Modell B är aritmetisk. År 8 är beloppet \\(1000+7\\cdot150=2050\\), så</p><p>\\[S_B=\\frac8{2}(1000+2050)=12200\\text{ kr}.\\]</p><p>Under just åtta år ger modell B mest. Modell A ökar procentuellt och har därför exponentiell tillväxt, medan modell B ökar med ett konstant belopp.</p><p><strong>Svar:</strong> modell B, \\(\\boxed{12\\,200\\text{ kr}}\\).</p>",
